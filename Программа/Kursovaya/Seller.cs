...
namespace Kursovaya
{
    public partial class Seller : Form
    {
        ...
        public string fio, user_role;

        Point location = new Point(205, 12);
        Size size = new Size(650, 550);
        Color c = Color.FromArgb(192, 192, 255);
        public Seller(string id, string fio, string login, string password, string user_role)
        {
            db = new DB();
            InitializeComponent();
        ...
        private void SaveToExcel(string file_name)
        {
            ...
            if (saveFileDialog1.ShowDialog() != DialogResult.Cancel)
            {
                ...
                {
                    exApp.Cells[1, i] = dataGridView4.Columns[i - 1].HeaderText;
                    exApp.Cells[1, i].StandardFont = "Times New Roman";
                    exApp.Cells[1, i].StandardFontSize = 14;
                }
                for (int i = 0; i < dataGridView4.Rows.Count; i++)
                {
                    for (int j = 0; j < dataGridView4.Columns.Count; j++)
                    {
                        exApp.Cells[i + 2, j + 1] = dataGridView4.Rows[i].Cells[j].Value.ToString();
                        exApp.Cells[i + 2, j + 1].StandardFont = "Times New Roman";
                        exApp.Cells[i + 2, j + 1].StandardFontSize = 14;
                    }
        ...
        private void buttonShowReport_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "По продажам товара за период")
            {
                ...
                dataGridView4.Columns[0].HeaderText = "Наименование товара";
                dataGridView4.Columns[1].HeaderText = "Количество";
                dataGridView4.Columns[2].HeaderText = "Цена";
                dataGridView4.Columns[3].HeaderText = "Сумма";
                dataGridView4.Columns[4].HeaderText = "Дата продажи";
            ...
            else if (comboBox1.Text == "По остаткам товара за период")
            {
                ...
                dataGridView4.Columns[0].HeaderText = "Наименование товара";
                dataGridView4.Columns[1].HeaderText = "Цена";
                dataGridView4.Columns[2].HeaderText = "Количество";
            ...
            else if (comboBox1.Text == "О заказанных у поставщиков товара за период")
            {
                ...
                dataGridView4.Columns[1].HeaderText = "Количество";
                dataGridView4.Columns[2].HeaderText = "Цена";
                dataGridView4.Columns[3].HeaderText = "Поставщик";
                dataGridView4.Columns[4].HeaderText = "Дата продажи";
            ...
            else if (comboBox1.Text == "По продажам сотрудников за период")
            {
                ...
                dataGridView4.Columns[0].HeaderText = "Сотрудник";
                dataGridView4.Columns[1].HeaderText = "Наименование товара";
                dataGridView4.Columns[2].HeaderText = "Количество";
                dataGridView4.Columns[3].HeaderText = "Сумма";
                dataGridView4.Columns[4].HeaderText = "Дата продажи";
            ...
            else //comboBox1.Items.Add("По продажам по каждому сотруднику за период");
            {
                ...
                dataGridView4.Columns[0].HeaderText = "Наименование товара";
                dataGridView4.Columns[1].HeaderText = "Количество";
                dataGridView4.Columns[2].HeaderText = "Сумма";
                dataGridView4.Columns[3].HeaderText = "Дата продажи";
